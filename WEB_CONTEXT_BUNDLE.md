...
```json
{
  ...
  "problem_contract": {
    ...
    "problem_id": "problem:um-amr-010-0311-questions-in-geometric-group-theory-q-1b4877b6",
    "quantifiers": [
      {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-amr-010-0311-606ebcfa8176",
        "url": "https://www.unsolvedmath.com/problems/AMR-010-0311"
      }
    ],
    "statement": {
      "language": "en",
      "text": "For $x\\in[F_n,F_n]$, define its genus as the least $g$ such that $x$ is a product of $g$ commutators. Let $f(g)$ be a uniform bound, independent of $x$, on the number of Nielsen-equivalence classes of expressions of a genus-$g$ element as a product of $g$ commutators. Give an explicit upper bound for $f(g)$.",
      "version": 1
    },
    "title": "Questions in Geometric Group Theory — Q 3.11",
    "updated_at": "2026-09-15T21:28:00.195364Z"
  },
  "problem_contract_sha256": "8a4c016980387bbbbdeb59b0eb89671319ba3f0a94be164956e6b3269ea139e7"
}
```
